...
{
    printf("Parse tree:\n");
    __dumptree(ps->p_grammar, ps->p_tree);
    printf("\n");
    printf("Tokens:\n");
    __showtree(ps->p_grammar, ps->p_tree);
    printf("\n");
    printf("Listing:\n");
